  ...
  if (prefersReducedMotion) {
    return (
      <div className="relative flex items-center justify-center w-[280px] h-[280px] sm:w-[400px] sm:h-[400px]">
        <div className="absolute w-full h-full border-2 border-dashed border-white/10 rounded-full" />
        <div className="absolute w-[70%] h-[70%] border border-dashed border-emerald-500/20 rounded-full" />
        ...
        <div className="relative z-10 w-20 h-20 sm:w-28 sm:h-28 rounded-full bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center backdrop-blur-3xl">
          <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-gradient-to-tr from-emerald-500 to-blue-500 blur-xl opacity-50 absolute" />
